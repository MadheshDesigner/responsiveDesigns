...
import '../../../view/screen/coming_soon_screen.dart';
...
class BottomNavigationBarScreen extends StatefulWidget {
  final int? pageIndex;
  const BottomNavigationBarScreen({super.key, required this.pageIndex});

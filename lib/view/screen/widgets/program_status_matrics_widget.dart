...
class ProgramStatusMatricWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      width: MediaQuery.of(context).size.width > 600 ?342:339,
      height: MediaQuery.of(context).size.width > 600 ? 399 : 415,
      padding: const EdgeInsets.fromLTRB(14, 16, 14, 16),
      margin: EdgeInsets.only(left: widthSize  * 0.02,right: widthSize  * 0.02,top: widthSize >600?5:3),
      ...
      child: Column(
        ...
        children: [
          ...
          Expanded(
            child: Row(
              ...
              children: [
               ...
               Container(
                 height: MediaQuery.of(context).size.width > 600 ? 300 : 210,
                 width: MediaQuery.of(context).size.width > 600 ? 3 : 2,
          ...
          Row(
            ...
            children: [
              textWidget("All programs", Theme.of(context).primaryColor,context),
              textWidget("Active", const Color(0xff7E9FD4),context),
              textWidget("Completed", const Color(0xffC7DEFF),context),
            ],
          ),
        ],
      ),
  ...
  List<BarChartGroupData> addDataValue() {
    ...
    return List.generate(12, (index) {
      return groupValues(index, data[index]);
    });
  }

  BarChartGroupData groupValues(int x, List<double> values) {
    final colors = [Colors.blue[200]!, Colors.blue, Colors.blue[900]!];
    return BarChartGroupData(
      x: x,
      barRods: List.generate(
        values.length,
            (i) => BarChartRodData(toY: values[i], color: colors[i], width: 10,borderRadius: BorderRadius.zero),
      ),
    );
  }

  Widget textWidget(String text, Color color,BuildContext context) {
    return Row(
      children: [
